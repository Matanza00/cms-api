...
function addModules() {
    return __awaiter(this, void 0, void 0, function () {
        var modules, _i, modules_1, module_1, existingModule, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!(_i < modules_1.length)) return [3 /*break*/, 7];
                    module_1 = modules_1[_i];
                    return [4 /*yield*/, prisma.module.findUnique({
                            where: { name: module_1.name },
                        })];
                case 3:
                    existingModule = _a.sent();
                    if (!!existingModule) return [3 /*break*/, 5];
                    return [4 /*yield*/, prisma.module.create({
                            data: module_1,
                        })];
                case 4:
                    _a.sent();
                    console.log("Module ".concat(module_1.name, " added successfully."));
                    return [3 /*break*/, 6];
                case 5:
                    console.log("Module ".concat(module_1.name, " already exists."));
                    _a.label = 6;
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
                ...
                case 8:
                    error_1 = _a.sent();
                    console.error("Error adding modules:", error_1);
                    return [3 /*break*/, 11];
